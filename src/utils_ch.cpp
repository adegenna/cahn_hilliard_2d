...
AppCtx parse_petsc_options( ) {
  ...
  PetscOptionsGetString(NULL,NULL,"-dirichlet_bc_thermal_array_file",tempfile_dirichlet_array,sizeof(tempfile_dirichlet_array),&flag_read);
  if (flag_read)
    user.dirichlet_thermal_array_file = std::string(tempfile_dirichlet_array);
  
  char tempfile_dirichlet_array_ch[PETSC_MAX_PATH_LEN];
  PetscOptionsGetString(NULL,NULL,"-dirichlet_bc_ch_array_file",tempfile_dirichlet_array_ch,sizeof(tempfile_dirichlet_array_ch),&flag_read);
  if (flag_read)
